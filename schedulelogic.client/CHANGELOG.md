...
- Create Angular project with ng: `ng new schedulelogic.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`schedulelogic.client.esproj`).
